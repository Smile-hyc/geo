...
import { LayoutDashboard, Image as ImageIcon, ClipboardList, Settings, LogOut, Gift, Download } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/admin/export", label: "导出数据", icon: <Download className="h-4 w-4" /> },
