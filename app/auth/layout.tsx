      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-6xl font-extrabold text-slate-900 leading-[1.1]">
            连接图像与空间<br />
            <span className="text-primary text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-blue-600">开启可信求证</span>
          </h1>

          <p className="text-lg text-slate-500 max-w-md">
            登录您的账号，继续体验“识图”快速初判与“寻境”高精度推理服务，
            并通过“地衡”平台沉淀任务与反馈数据。
          </p>

          <div className="grid grid-cols-2 gap-4 pt-4">
            {[
              { label: "识图能力", value: "Fast" },
              { label: "寻境能力", value: "Verified" },
            ].map((item) => (
